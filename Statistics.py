...
class Statistics(tk.Frame):
    ...
    def stats(self, username_stats2):
        ...
        def test1results(username_stats2, jsonfile):
        ...
        def test2results(username2, jsonfile):
        ...
        def bothresults(username_stats2, jsonfile):
            test1results(username_stats2, jsonfile)
            test2results(username_stats2, jsonfile)
            
        for test1 in json_decode:
            if test1 == username_stats:
                bothresults(username_stats2,json_decode)
            else:
